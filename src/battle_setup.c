...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_HARUHI] = REMATCH(TRAINER_HARUHI_1, TRAINER_HARUHI_2, TRAINER_HARUHI_3, TRAINER_HARUHI_4, TRAINER_HARUHI_5, ROUTE111),
    ...
    [REMATCH_BROOK] = REMATCH(TRAINER_BROOK_1, TRAINER_BROOK_2, TRAINER_BROOK_3, TRAINER_BROOK_4, TRAINER_BROOK_5, DEWFORD_TOWN),
...
{
    CreateMaleMon(&gEnemyParty[0], SPECIES_RALTS, 5, MON_DATA_IS_SHINY);
    LockPlayerFieldControls();
