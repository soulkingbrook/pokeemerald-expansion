...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_ENDEAVOR] =
    {
        .name = COMPOUND_STRING("ENDEAVOUR"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ODOR_SLEUTH] =
    {
        .name = COMPOUND_STRING("ODOUR SLEUTH"),
        .description = COMPOUND_STRING(
            "Negates the foe's efforts\n"
            "to heighten evasiveness."),
        .effect = EFFECT_FORESIGHT,
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("ParabolcChrg", "PARABOLA CHARGE"),
        .description = COMPOUND_STRING(
            "Hits adjacent POKéMON and\n"
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("ElctrcTrrain", "ELECTRO TERRAIN"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("PrcipceBldes", "RAGGED BLADES"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("FrstImpressn", "1ST IMPRESSION"),
        .description = COMPOUND_STRING(
            "Hits hard and first.\n"
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("RvlationDnce", "REVEALING DANCE"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("StmpngTantrm", "STOMPING TEMPER"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Natur'sMadns", "NATURE'S WRATH"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PIKA_PAPOW] =
    {
        ...
        .description = COMPOUND_STRING(
            "PIKACHU'S love increases\n"
            "its power. Never misses."),
        .effect = EFFECT_RETURN,
        .power = 1,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("DublIronBash", "X2 IRON BASH"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MISTY_EXPLOSION] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hits everyone and faints.\n"
            "Stronger on MISTY TERRAIN."),
        .effect = EFFECT_EXPLOSION,
        .power = 100,
        .type = TYPE_FAIRY,
        .accuracy = 100,
    ...
    [MOVE_SKITTER_SMACK] =
    {
        ...
        .description = COMPOUND_STRING(
            "User attacks behind foe,\n"
            "lowering the foe's SP. ATK."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_BUG,
        .accuracy = 90,
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("BrningJelosy", "FIERY JEALOUSY"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("SprngtdeStrm", "SPRING STORM"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHELTER] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user hardens its skin,\n"
            "sharply raising its DEF."),
        .effect = EFFECT_DEFENSE_UP_2,
        .power = 0,
        .type = TYPE_STEEL,
        .accuracy = 0,
    ...
    [MOVE_SPIN_OUT] =
    {
        ...
        .description = COMPOUND_STRING(
            "User madly strains its legs,\n"
            "harshly lowering its SPEED."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("RevivlBlesng", "REVIVE BLESSING"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_STEP] =
    {
        ...
        .description = COMPOUND_STRING(
            "User hits with fluid dance\n"
            "steps, raising its SPEED."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("ColisinCours", "COLLISION CRASH"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("ChilReceptin", "COLD RECEPTION"),
        .description = COMPOUND_STRING(
            "Bad joke causes snowstorm.\n"
    ...
    [MOVE_ARMOR_CANNON] =
    {
        .name = COMPOUND_STRING("ARMOUR CANNON"),
        .description = COMPOUND_STRING(
            "A strong attack but lowers\n"
            "the defensive stats."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ELECTRO_SHOT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Absorbs electricity in one\n"
            "turn and attacks the next."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 130,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_TERA_STARSTORM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Damages all opponents if user\n"
            "is STELLAR TERAPAGOS."),
    ...
    {
        .name = COMPOUND_STRING("PULVERISING PANCAKE"),
        .description = sNullDescription,
        .effect = EFFECT_HIT,
        .power = 210,
        .type = TYPE_NORMAL,
    ...
    [MOVE_G_MAX_MALODOR] =
    {
        .name = COMPOUND_STRING("G-MAX MALODOUR"),
        .description = sNullDescription,
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_POISON,
