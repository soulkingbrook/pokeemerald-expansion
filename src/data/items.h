...
static const u8 sGenericMulchDesc[]   = _("A fertiliser that\n"
                                          "is unsuitable for\n"
                                          "local soil.");
...
// Fossils
    ...
    {
        .name = HANDLE_EXPANDED_ITEM_NAME("FosslzedBird", "FOSSILISED BIRD"),
        .price = 5000,
        .description = COMPOUND_STRING(
            "A fossil of an\n"
            "ancient, sky-\n"
    ...
    {
        .name = HANDLE_EXPANDED_ITEM_NAME("FosslzedFish", "FOSSILISED FISH"),
        .pluralName = HANDLE_EXPANDED_ITEM_NAME("FosslzedFishes", "FOSSILISED FISH"),
        .price = 5000,
    ...
    {
        .name = HANDLE_EXPANDED_ITEM_NAME("FosslzedDrke", "FOSSILISED DRAKE"),
        .price = 5000,
        .description = COMPOUND_STRING(
            "A fossil of an\n"
            "ancient, land-\n"
    ...
    {
        .name = HANDLE_EXPANDED_ITEM_NAME("FosslzedDino", "FOSSILISED DINO"),
        .price = 5000,
        .description = sFossilizedFishDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
...
// Apricorns
    ...
    [ITEM_ARMORITE_ORE] =
    {
        .name = _("ARMOURITE ORE"),
        .pluralName = _("ARMOURITE ORE"),
        .price = 20,
        .description = COMPOUND_STRING(
            "A rare ore. Can be\n"
            "found in the ISLE\n"
...
// Form-changing Key Items
    ...
    [ITEM_ROTOM_CATALOG] =
    {
        .name = HANDLE_EXPANDED_ITEM_NAME("RotomCatalog", "ROTOM CATALOGUE"),
        .price = 0,
        .importance = 1,
        .description = COMPOUND_STRING(
            "A catalogue full of\n"
