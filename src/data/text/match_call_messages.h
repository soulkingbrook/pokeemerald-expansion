...
const u8 gText_MatchCallSoulKing_Brook_Strategy[] = _("Patience is the key.");
const u8 gText_MatchCallSoulKing_Brook_Pokemon[] = _("GHOST POKéMON rock!");
const u8 gText_MatchCallSoulKing_Brook_Intro1[] = _("I've been a musician for");
const u8 gText_MatchCallSoulKing_Brook_Intro2[] = _("almost 90 years now.");
...
const u8 *const gMatchCallFlavorTexts[REMATCH_TABLE_ENTRIES][CHECK_PAGE_ENTRY_COUNT] =
{
    ...
    [REMATCH_BROOK] = MCFLAVOR(SoulKing_Brook),
