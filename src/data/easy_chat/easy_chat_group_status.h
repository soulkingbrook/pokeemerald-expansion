...
const u8 gEasyChatWord_Color[] = _("COLOUR");
const u8 gEasyChatWord_AltColor[] = _("ALT. COLOUR");
...
const u8 gEasyChatWord_BattleArmor[] = _("BATTLE ARMOUR");
...
const u8 gEasyChatWord_ShellArmor[] = _("SHELL ARMOUR");
...
const u8 gEasyChatWord_Lightningrod[] = _("LIGHTNING ROD");
const u8 gEasyChatWord_Compoundeyes[] = _("COMPOUND EYES");
...
const u8 gEasyChatWord_ColorChange[] = _("COLOUR CHANGE");
...
const u8 gEasyChatWord_MagmaArmor[] = _("MAGMA ARMOUR");
