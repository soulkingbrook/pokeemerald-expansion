...
static const u8 sText_NoRunningFromTrainers[] = _("No! Only pussies run from\nTRAINER battles!\p");
static const u8 sText_CantEscape[] = _("Can't escape!\p");
static const u8 sText_DontLeaveBirch[] = _("PROF. BIRCH: Don't just leave me to die!\p");
...
static const u8 sText_PkmnWontObey[] = _("{B_ATK_NAME_WITH_PREFIX} played ROM HACKS\ninstead of obeying!");
...
static const u8 sText_PkmnOkComeBack[] = _("{B_BUFF1}, okay!\nCome back!");
...
static const u8 sText_AarghAlmostHadIt[] = _("Damn!\nAlmost had it!");
...
static const u8 sText_WonderRoomEnds[] = _("WONDER ROOM wore off, and DEFENCE\nand SP. DEF stats returned to normal!");
...
static const u8 sText_MoldBreakerEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} breaks the mould!");
...
static const u8 sText_NeutralizingGasEnters[] = _("NEUTRALISING GAS filled the area!");
static const u8 sText_NeutralizingGasOver[] = _("The effects of NEUTRALISING\nGAS wore off!");
...
static const u8 sText_ElectricTerrainActivatedAbility[] = _("The ELECTRO TERRAIN activated\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ABILITY}!");
