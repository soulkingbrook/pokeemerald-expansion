...
#define P_LVL_UP_LEARNSETS          GEN_9       // Choose which set of Level Up Learnsets to use.
                                                // For generations that hadn't introduced a species yet, we use their first appearance (eg. Chikorita's Gen2 data if the config is set to GEN_1).
...
#define P_FLAG_FORCE_SHINY      0x2BA     // If this flag is set, all wild and gift Pokémon will forced into being Shiny.
